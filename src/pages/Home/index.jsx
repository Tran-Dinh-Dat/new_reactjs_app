            ...
            <div className="masonry">
              ...
              <article className="masonry__brick entry format-video animate-this">
                <div className="entry__thumb video-image">
                  <a
                    href="https://player.vimeo.com/video/117310401?color=339989&title=0&byline=0&portrait=0"
                    data-lity=""
                ...
                <div className="entry__text">
                  <div className="entry__header">
                    <h2 className="entry__title">
                      <a href="single-video.html">No Sugar Oatmeal Cookies.</a>
                    </h2>
                    <div className="entry__meta">
                      <span className="entry__meta-cat">
                        <a href="category.html">Lifestyle</a>
              ...
              <article className="masonry__brick entry format-link animate-this">
                <div className="entry__thumb">
                  <div className="link-wrap">
                    <h2>
                      Powerful web &amp; Wordpress hosting. Guaranteed. Starting
                      at $2.59/mo!
                    </h2>
                    <cite>
                      <a
                  ...
                  <div className="entry__header">
                    <h2 className="entry__title">
                      <a href="single-gallery.html">
                        The Best Tropical Leaves Images.
                      </a>
                    </h2>
                    <div className="entry__meta">
                      <span className="entry__meta-cat">
